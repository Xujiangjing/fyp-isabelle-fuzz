...
ML \<open>
  let
    val proof_text = "% done 0 iterations in 0.007s\n% SZS status ResourceOut for '/Users/xujiangjing/fyp-isabelle-fuzz/unique_inputs/0000_r001_20260331_221018_prob_zipperposition_1.p'\n% SZS output start Refutation\nthf(list_int_type, type, list_int: $tType).\nthf(s_type, type, s: list_int).\nfof(injected_2209, plain, $true, inference(trust_me_bro, [status(thm)], [])).\nthf(conj_0, conjecture, (( s ) = ( s ))).\nthf(zf_stmt_0, negated_conjecture, (( s ) != ( s )),\n  inference('cnf.neg', [status(esa)], [conj_0])).\nthf(zip_derived_cl32, plain, (((s) != (s))),\n    inference('cnf', [status(esa)], [zf_stmt_0])).\nthf(zip_derived_cl35, plain, ($false),\n    inference('simplify', [status(thm)], [zip_derived_cl32])).\n\n% SZS output end Refutation\n"
