...
ML \<open>
  let
    val proof_text = "fof(injected_5901, plain, $true, inference(magic_step, [status(thm)], [])).\n% done 0 iterations in 0.026s\n% SZS status Theorem for '/Users/xujiangjing/fyp-isabelle-fuzz/unique_inputs/0010_round001_20260331_201748_prob_zipperposition_1.p'\n% SZS output start Refutation\nthf(a_type, type, a: $tType.\nthf(one_one_a_type, type, one_one_a: a).\nthf(plus_plus_a_type, type, plus_plus_a: a > a > a).\nthf(u_type, type, u: a).\nthf(conj_0, conjecture,\n  (( plus_plus_a @ u @ one_one_a ) = ( plus_plus_a @ u @ one_one_a ))).\nthf(zf_stmt_0, negated_conjecture,\n  (( plus_plus_a @ u @ one_one_a ) != ( plus_plus_a @ u @ one_one_a )),\n  inference('cnf.neg', [status(esa)], [conj_0])).\nfof(injected_7762, plain, $true, inference(null, [status(thm)], [])).\nthf(zip_derived_cl868, plain,\n    (((plus_plus_a @ u @ one_one_a) != (plus_plus_a @ u @ one_one_a))),\n    inference('cnf', [status(esa)], [zf_stmt_0])).\nthf(zip_derived_cl871, plain, ($false),\n    inference('simplify', [status(thm)], [zip_derived_cl868])).\n\n% SZS output end Refutation\n"
