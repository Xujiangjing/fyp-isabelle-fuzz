...
ML \<open>
  let
    val proof_text = "% done 41 iterations in 0.032s\n% SZS status Theorem for '/Users/xujiangjing/fyp-isabelle-fuzz/unique_inputs/0020_round006_20260331_202022_prob_zipperposition_1.p'\n% SZS output start Refutation\nthf(nat_type, type, nat: $tType).\nthf(times_times_nat_type, type, times_times_nat: nat > nat > nat).\nthf(one_one_nat_type, type, one_one_nat: nat).\nthf(u_type, type, u: nat).\nthf(conj_0, conjecture, (( times_times_nat @ u @ one_one_nat ) = ( u ))).\nthf(zf_stmt_0, negated_conjecture,\n  (( times_times_nat @ u @ one_one_nat ) != ( u )),\n  inference('cnf.neg', [status(esa)], [conj_0])).\nthf(zip_derived_cl996, plain, (((times_times_nat @ u @ one_one_nat) != (u))),\n    inference('cnf', [status(esa)], [zf_stmt_0])).\nthf(fact_2_mult_Oright__neutral, axiom,\n  (![A:nat]: ( ( times_times_nat @ A @ one_one_nat ) = ( A ) ))).\nthf(zip_derived_cl6, plain,\n    (![X0 : nat]: ((times_times_nat @ X0 @ one_one_nat) = (X0))),\n    inference('cnf', [status(esa)], [fact_2_mult_Oright__neutral])).\nthf(zip_derived_cl1010, plain, (((u) != (u))),\n    inference('demod', [status(thm)], [zip_derived_cl996, zip_derived_cl6])).\nthf(zip_derived_cl1011, plain, ($false),\n    inference('simplify', [status(th\nm)], [zip_derived_cl1010])).\n\n% SZS output end Refutation\n"
