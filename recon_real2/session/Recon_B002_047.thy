...
ML \<open>
  let
    val proof_text = "% done 0 iterations in 0.001s\n% SZS status CounterSatisfiable for '/Users/xujiangjing/fyp-isabelle-fuzz/unique_inputs/0013_round002_20260331_201817_prob_zipperposition_min_1.p'\n% SZS output start Refutation\nthf(nat_type, type, nat: $tType).\nthf(m_type, type, m: nat).\nthf(conj_0, conjecture, (( m ) = ( m ))).\nthf(zf_stmt_0, negated_conjecture, (( m ) != ( m )),\n  inference('cnf.neg', [status(esa)], [conj_0])).\nthf(zip_derived_cl0, plain, (((m) != (m))),\n    inference('cnf', [status(esa)], [zf_stmt_0])).\n"
