...
ML \<open>
  let
    val proof_text = "% /usr/local/bin/vampire --input_syntax tptp --proof tptp --output_axiom_names on --mode portfolio --schedule snake_slh -t 30 --input_file /Users/xujiangjing/.isabelle/Isabelle2025/prob_vampire_1.p\n% 2026-04-04 13:22:07.734\nUser error: snake_slh is an invalid value for schedule\nSee vampire -explain schedule for help.% /usr/local/bin/vampire --input_syntax tptp --proof tptp --output_axiom_names on --mode portfolio --schedule snake_slh -t 30 --input_file /Users/xujiangjing/.isabelle/Isabelle2025/prob_vampire_1.p\n% 2026-04-04 13:22:07.734\nUser error: snake_slh is an invalid value for schedule\nSee vampire -explain schedule for help.fof(a,axiom,($true)).\n"
